...
if (isset($_POST['action']) && $_POST['action'] == 'preview') {
    try {
        ...
        // Get selected columns if provided
        $selectedColumns = [];
        ...
        if (empty($selectedColumns)) {
            $selectedColumns = $tableFields[$targetTable];
        }
    ...
    try {
        ...
        if (isset($_POST['selected_columns']) && is_array($_POST['selected_columns'])) {
            ...
            foreach ($selectedColumns as $column) {
                if (!in_array($column, $tableFields[$targetTable])) {
                    throw new Exception("Invalid column selected: $column");
                }
            }
        } else {
            // If no columns explicitly selected, use all available columns
            $selectedColumns = $tableFields[$targetTable];
        }
