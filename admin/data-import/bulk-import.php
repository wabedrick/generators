    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="bulk-import-process.php" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                    <div class="col-md-6">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Update key field options when table changes
