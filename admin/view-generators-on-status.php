...
// Get the generator status from the URL
$generator_status = isset($_GET['status']) ? $_GET['status'] : '';
...
// Fetch generators based on status
$sql = "SELECT
...
<main id="main" class="main">
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">List of <?php echo ($generator_status != '' ? $generator_status : 'Unknown'); ?> Generators</h2>
                    <hr>

                    <button onclick="window.location.href='export-generators.php?status=<?php echo $generator_status; ?>&format=csv'" class="btn btn-primary">Download as CSV</button>
                    <button onclick="window.location.href='export-generators.php?status=<?php echo $generator_status; ?>&format=excel'" class="btn btn-secondary">Download as Excel</button>
                    <hr>
                ...
                <table class="table datatable table-striped">
                    ...
                    <tbody>
                        ...
                        while ($generator = $result->fetch_assoc()) {
                            ...
                            // Calculate runtime hours and age in months
