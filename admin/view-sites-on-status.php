...
<main id="main" class="main">
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">List of <?php echo ($site_status != '' ? $site_status : 'Unknown'); ?> Sites</h2>
                    <hr>

                    <button onclick="window.location.href='export-sites.php?site_status=<?php echo $site_status; ?>&format=csv'" class="btn btn-primary">Download as CSV</button>
                    <button onclick="window.location.href='export-sites.php?site_status=<?php echo $site_status; ?>&format=excel'" class="btn btn-secondary">Download as Excel</button>
                    <hr>
